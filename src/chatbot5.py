...
class IndexQuerySol5:
    def __init__(self,
        ...
        self.review_system_prompt2 = self.review_system_prompt2()
    ...
    def review_system_prompt(self):
        ...
        review_template_str = """Your job is to use documents from the pedagogues' union to answer questions concerning the union. Use the following context to answer questions.
    ...
    def review_system_prompt2(self):

        instruction = "Questions should always be replied in Danish."
        ...
        review_chain = (
                        ...
                        | LangChainPredict(
                            self.review_prompt_template,
                                            chat_model
                                            )         # ISSUE: https://github.com/stanfordnlp/dspy/issues/510
                        | output_parser)


        dspy_review_chain = LangChainModule(
                    review_chain
                )
        
        return dspy_review_chain
...
if __name__ == "__main__":
    ...
    parameter_dict = {'temperature': TEMPERATURE,
        ...
        # Create class
    result = IndexQuerySol5(index_name=INDEX_NAME,
